...
import { IHeader, ISPAppConfigService } from './shared/services/isp-app-config.service';
...
export class AppComponent implements OnInit {
  ...
  public accent;
  public warn;
  public headerObj: IHeader;
  showChlngeIcon = false;
  showDealIcon = false;
  public toogleMenuCondition = true;

  constructor(private ispAppConfigService: ISPAppConfigService, private policyService: PolicyAppService, private renderer: Renderer2, private router: Router) { }
